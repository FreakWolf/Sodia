...
import static com.example.sodia.fragments.CreateAccountFragment.EMAIL_REGEX;
...
public class LoginFragment extends Fragment {
    ...
    private void init(View view){
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("77919230047-m5837sovrb7guel00ahrvm4r0sil17fn.apps.googleusercontent.com")
                .requestEmail()
                .build();
    ...
    private void clickListener(){
        ...
        loginBtn.setOnClickListener((v) -> {
                ...
                if (password.isEmpty() || password.length() < 6){
                    passET.setError("Input valid 6 digit password");
                    return;
                }
        ...
        signUpTV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((FragmentReplaceActivity) requireActivity()).setFragment(new CreateAccountFragment());
            }
        });
